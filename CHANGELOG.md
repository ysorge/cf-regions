...
This will be the first public release on GitHub and PyPI.
...
- Declarative, versioned spatial-interpretation profiles with additive external
  profile directories and discovery APIs.
